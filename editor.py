'''This file contains class with which editor in the Programmophone was created
Major ideas as well as code for editor was borrowed from stackoverflow and was used with some changes
...
class CustomFrame(Frame):
    ...
    #On change configures the current cursor position in the label placed at the bottom side of editor
    ...
    #On change redraws line numbers
